...
from . import views
from .views import ProfileDetailView, EditProfileView, PostCreateView, PostDetailView, IndexView, CategoryPostsView
...
urlpatterns = [
    ...
    path('edit-profile/<slug:username>/', EditProfileView.as_view(), name='edit_profile'),
